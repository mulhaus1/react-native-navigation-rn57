...
- (void)applyOn:(UIViewController *)viewController {
	...
	if (self.badge) {
		...
		if (self.badgeColor) {
			[tabBarItem setBadgeTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor blackColor], NSForegroundColorAttributeName, nil] forState:UIControlStateNormal];
		}
